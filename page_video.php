...
<script type="text/javascript" src="php/_libs/flowplayer/flowplayer-3.2.6.min.js"></script>
<script src="php/page_video.js" type="text/javascript" charset="UTF-8"></script>
  ...
  <div class=thecolumns>
    <div class=centercol>
      <div class=picbox>
        ...
        <div class=options>режим показа роликов: <a onClick=wc.vplayMode(1) class=pm1>повторять один</a> <a onClick=wc.vplayMode(2) class="pm2 cur">показывать один за другим</a></div>
    ...
    <div class="bestshotsbox">Лучшие видео
